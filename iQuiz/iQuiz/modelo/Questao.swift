...
let questoes: [Questao] = [
    ...
    Questao(titulo: "Qual destes é um framework de Swift?", respostas: ["UIKit", "React", "Flask"], respostaCorreta: 0),
    Questao(titulo: "Como declarar uma constante em Swift?", respostas: ["const", "var", "let"], respostaCorreta: 2),
    Questao(titulo: "Swift é utilizado para programar para qual destes OS?", respostas: ["Windows", "Linux", "IOS"], respostaCorreta: 2),
    ...
    Questao(titulo: "Como é chamada uma função que pertence a um objeto em Swift?", respostas: ["Property", "Function", "Method"], respostaCorreta: 2),
